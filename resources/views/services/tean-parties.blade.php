...
<div class="detail-container">
    ...
    <p class="detail-lead">Trendy, energetic parties with music, themes and safe supervision — perfect for milestone birthdays and celebrations.</p>

    <div class="grid">
        <div>
            <h3 class="section-title">What we offer</h3>
            <p>From custom playlists and DJ setups to themed décor and photo-ops — we create teen-friendly experiences that feel fresh and cool.</p>

            <h3 class="section-title">Features</h3>
            <ul class="features">
                <li>DJ/playlist curation and dance floor setup</li>
                <li>Lighting effects and projection visuals</li>
                <li>Food stations, mocktail bars, dessert tables</li>
                <li>Social-media ready photo areas & props</li>
            </ul>

            <h3 class="section-title">Safety & supervision</h3>
            <ul class="features">
                <li>Trained staff and clear rules</li>
                <li>Optional chaperone services</li>
            </ul>
        </div>
        ...
        <aside class="card">
            ...
            <div class="price-box">
                <div style="font-weight:700;color:#ae674e;">Starting at $700</div>
                <small>Includes DJ, basic lighting and catering (up to 50 guests).</small>
            </div>

            <h4 class="section-title" style="margin-top:12px;">Upgrades</h4>
            <ul class="features">
                <li>Professional DJ/artist</li>
                <li>Premium lighting & photo booth</li>
            </ul>

            <div style="text-align: center; margin-top: 30px;">
    <a href="{{ route('book.details', ['serviceName' => urlencode('team parties'), 'charges' => 700]) }}" class="book-btn">
        Book Now
    </a>
</div>
