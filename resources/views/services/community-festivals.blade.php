...
@section('title', 'Community Festivals')
...
<div class="detail-container">
    <h1 class="detail-title">Community Festivals</h1>
    <p class="detail-lead">Large-scale community events to bring neighbours together — logistics, vendor stalls, entertainment and safety planning handled end-to-end.</p>

    <div class="grid">
        <div>
            <h3 class="section-title">Event scope</h3>
            <ul class="features">
                <li>Vendor & food-stall management</li>
                <li>Stage scheduling and artist bookings</li>
                <li>Permits, crowd control & sanitation planning</li>
                <li>Volunteer coordination and sponsorship packages</li>
            </ul>

            <h3 class="section-title">Good for</h3>
            <ul class="features">
                <li>Street fairs, cultural days, local markets</li>
            </ul>
        </div>
        ...
        <aside class="card">
            ...
            <div class="price-box">
                <div style="font-weight:700;color:#ae674e;">Custom pricing</div>
                <small>Depends on scale, permits and vendor numbers. Typical community festival budgets start around $8,000.</small>
            </div>

            <div style="text-align: center; margin-top: 30px;">
    <a href="{{ route('book.details', ['serviceName' => urlencode('Community festivals'), 'charges' => 8000]) }}" class="book-btn">
        Book Now
    </a>
</div>
